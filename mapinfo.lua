...
local mapinfo = {
	...
	atmosphere = {
		...
		fogStart     = 0.5,
		fogEnd       = 1.0,
		fogColor     = {0.0, 0.1, 0.1},

		sunColor     = {0.5, 0.6, 1.0},
		skyColor     = {0.01, 0.0, 0.1},
		skyDir       = {0.0, 0.0, -1.0},
		skyBox       = "",
	...
	lighting = {
		...
		groundAmbientColor  = {0.1, 0.12, 0.1},
		groundDiffuseColor  = {0.5, 0.5, 0.5},
		groundSpecularColor = {0.09, 0.1, 0.1},
		groundShadowDensity = 0.8,
		unitAmbientColor    = {0.2, 0.2, 0.2},
		unitDiffuseColor    = {0.7, 0.7, 0.7},
		unitSpecularColor   = {0.5, 0.66, 0.7},
